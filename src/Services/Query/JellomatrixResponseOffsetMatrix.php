...
/**
 * Description of JellomatrixResponseOffsetMatrix
 *
 * @author eleven11
 */
class JellomatrixResponseOffsetMatrix {
  
  /**
   * Returns the Response Matrix.
   * name: jellomatrix_response_offset_matrix
   * @param $tone
   * @param $interval
   * @param $offset
   * @return = array()
   *
   **/
  public function getResponseOffsetMatrix($tone, $interval, $offset) {
    $matrix_count = 1;
    $response_bt = array();
  ...
  public function getABHAResponseOffsetMatrix($tone, $interval, $offset) {
    $matrix_count = 1;
    $response_bt = array();
