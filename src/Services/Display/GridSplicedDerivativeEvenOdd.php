...
/**
 * Description of GridSplicedDerivativeEvenOdd
 *
 * @author eleven11
 */
class GridSplicedDerivativeEvenOdd {
  
  /**
   * Returns the SplicedDerivativeEvenOdd for the Waves.
   * name: grid_spliced_derivative_even_odd
   * @return = string
   *
   **/
  public function getGridSplicedDerivativeEvenOdd($increments_prime, $tone, $harmonics, $frequency) {
