...
/**
 * Description of GridSplicedDerivativeHarmonics
 *
 * @author eleven11
 */
class GridSplicedDerivativeHarmonics {
  
  /**
   * Returns the SplicedDerivativeHarmonics for the Waves.
   * name: grid_spliced_derivative_harmonics
   * @return = string
   *
   **/
  public function getGridSplicedDerivativeHarmonics($increment_original, $harmonics, $primes, $tone, $frequency) {
