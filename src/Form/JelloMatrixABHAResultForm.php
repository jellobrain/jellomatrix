...
class JelloMatrixABHAResultForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $tone = NULL, $interval = NULL, $frequency = NULL, $print = NULL) {
    ...
    $response_matrix = $this->response_matrix->getABHAResponseMatrix($tone, $interval);
    $spliced_matrix = $this->spliced_matrix->getABHASplicedMatrix($response_matrix, $prime_matrix, $tone, $interval);
