...
class JelloMatrixABHADoubleFlipResultForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $tone = NULL, $interval = NULL, $frequency = NULL, $print = NULL) {
    ...
    $response_matrix = $this->doubleflip_response_matrix->getABHADoubleflipResponseMatrix($tone, $interval);
    $spliced_matrix = $this->doubleflip_spliced_matrix->getABHADoubleflipSplicedMatrix($response_matrix, $prime_matrix, $tone, $interval);
