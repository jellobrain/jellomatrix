...
class JelloMatrixSidebar extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $list = '<ol><li>' . $this->t('Bands of numbers in the spliced matrix with equal values adjacent to one another...') . '</li><li>' . $this->t('which connect in predictable sine wave forms with one another...') . '</li><li>' . $this->t('following the order of a scale which is determined by the top row of values in the unspliced and native "seed" matrix...') . '</li><li>' . $this->t('rhythms that are even numbered change polarity at the crests of the waveforms, while odd rhythms change polarity at each shift in position.') . '</li><li>' . $this->t('and harmonically cycle between zero and infinity.') . '</li></ol>';
