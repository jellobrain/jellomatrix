                    ...
                    if (!empty($next_position)) {
                      ...
                      foreach ($scale as $s => $svalue) {
                        if (isset($current_position['tone']) && !in_array($current_position['tone'], $scale_record) && $current_position['tone'] == $svalue && $s >= $interval && $s <= 2 * $interval) {
                          if (isset($next_position['tone']) && $next_position['tone'] == $scale[$s]) {
                            if (isset($next_next_position['tone']) && $next_next_position['tone'] == $scale[$s + 1]) {
                              if (isset($next_next_next_position['tone']) && $next_next_next_position['tone'] == $scale[$s + 2]) {
                        ...
                        elseif (isset($current_position['tone']) && !in_array($current_position['tone'], $scale_record) && $current_position['tone'] == $svalue && $s >= $interval && $s <= 2 * $interval) {
                          if (isset($next_position['tone']) && $next_position['tone'] == $scale[$s]) {
                            if (isset($next_next_position['tone']) && $next_next_position['tone'] == $scale[$s + 1]) {
                              if (isset($next_next_adjacent_position['tone']) && $next_next_adjacent_position['tone'] == $scale[$s + 1]) {
                                $scale_record[] = $current_position['tone'];
                                $calc_scale[$j][$jount]['scale'] = $s;
                                $calc_scale[$j][$jount]['tone'] = $current_position['tone'];
                                $jount++;
                        ...
                        elseif (isset($current_position['tone']) && !in_array($current_position['tone'], $scale_record) && $current_position['tone'] == $svalue && $s >= $interval && $s <= 2 * $interval) {
                          if (isset($next_position['tone']) && $next_position['tone'] == $scale[$s + 1]) {
                            if (isset($next_next_position['tone']) && $next_next_position['tone'] == $scale[$s + 2]) {
                              if (isset($next_next_next_position['tone']) && $next_next_next_position['tone'] == $scale[$s + 3]) {
                                $scale_record[] = $current_position['tone'];
                                $calc_scale[$j][$jount]['scale'] = $s;
                                $calc_scale[$j][$jount]['tone'] = $current_position['tone'];
                                $jount++;
                        ...
                        elseif (isset($current_position['tone']) && !in_array($current_position['tone'], $scale_record) && $current_position['tone'] == $svalue && $s >= $interval && $s <= 2 * $interval) {
                          if (isset($next_position['tone'])  && $next_position['tone'] == $scale[$s + 1]) {
                            if (isset($next_next_position['tone']) && $next_next_position['tone'] == $scale[$s + 1]) {
                              if (isset($next_next_adjacent_position['tone']) && $next_next_adjacent_position['tone'] == $scale[$s + 2]) {
                                $scale_record[] = $current_position['tone'];
                                $calc_scale[$j][$jount]['scale'] = $s;
                                $calc_scale[$j][$jount]['tone'] = $current_position['tone'];
                                $jount++;
                        ...
                        elseif (isset($current_position['tone']) && !in_array($current_position['tone'], $scale_record) && $current_position['tone'] == $svalue && $s >= $interval && $s <= 2 * $interval) {
                          if (isset($next_position['tone']) && $next_position['tone'] == $scale[$s + 1]) {
                            if (isset($next_next_position['tone']) && $next_next_position['tone'] == $scale[$s + 1]) {
                                if (isset($next_next_next_position['tone']) && $next_next_adjacent_position['tone'] != $scale[$s + 2]) {
                                $scale_record[] = $current_position['tone'];
                                $calc_scale[$j][$jount]['scale'] = $s;
                                $calc_scale[$j][$jount]['tone'] = $current_position['tone'];
                                $jount++;
                      ...
                      foreach ($scale as $s => $svalue) {
                        ...
                        elseif (isset($current_position['tone']) && !in_array($current_position['tone'], $scale_record) && $current_position['tone'] == $svalue && $s >= $interval && $s <= 2 * $interval) {
                          if (isset($next_position['tone']) && $next_position['tone'] == $scale[$s]) {
                            if (isset($next_next_position['tone']) && $next_next_position['tone'] == $scale[$s - 1]) {
                              if (isset($next_next_next_position['tone']) && $next_next_adjacent_position['tone'] == $scale[$s - 1]) {
                                $scale_record[] = $current_position['tone'];
                                $calc_scale[$j][$jount]['scale'] = $s;
                                $calc_scale[$j][$jount]['tone'] = $current_position['tone'];
                                $jount++;
