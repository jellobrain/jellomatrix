 ...
 *
 * @Block(
 *   id = "jellomatrix_spliced_matrix_derivatives_block",
 *   admin_label = @Translation("Jellomatrix Spliced Matrix Derivatives Block"),
 *   category = @Translation("JelloMatrix block")
 * )
 */
class JellomatrixSplicedMatrixDerivativesBlock extends BlockBase {
