 ...
 *
 * @Block(
 *   id = "jellomatrix_spliced_matrix_derivative_even_odd_block",
 *   admin_label = @Translation("Jellomatrix Spliced Matrix Derivative Even Odd Block"),
 *   category = @Translation("JelloMatrix block")
 * )
 */
class JellomatrixSplicedMatrixDerivativeEvenOddBlock extends BlockBase {
   ...
   */
  public function defaultConfiguration($increments_prime, $tone, $harmonics, $frequency) {
    ...
    $intro .= '<div class="endtable begintext"><h2>PRIMARY MATRIX DERIVATIVES ODD+EVEN: Derivatives</h2>';
    $intro .= '<p>The bold letters at the end of each row represent the Lambdona Notes that the ratios of repeating PRIMARY MATRIX increments create.</p><div class="endtext"><br></div>';
