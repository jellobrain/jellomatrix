 ...
 *
 * @Block(
 *   id = "jellomatrix_intro_block",
 *   admin_label = @Translation("Jellomatrix Intro Block"),
 *   category = @Translation("JelloMatrix block")
 * )
 */
class JellomatrixIntroBlock extends BlockBase {
  ...
  public function build() {
    return [
      '#markup' => $this->configuration['jellomatrix_intro_string'],
    ];
  }
